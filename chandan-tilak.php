...
<html lang="en">
  <head>
    ...
    <title>Prabhu Priya | Chandan Tilak</title>
    <!-- web fonts -->
...
<section class="w3l-service-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      <h2>Chandan Tilak</h2>
      <p><a href="index.php">Home</a> &nbsp; / &nbsp;<a href="products.php"> Products </a>&nbsp; / &nbsp; Chandan Tilak</p>
    </div>
  </div>
</section>
...
$qry =$con->prepare("SELECT id,cat,h1,image,image2 FROM gallery WHERE cat = '4' LIMIT {$offset},{$limit}  ");
    			 $qry->execute();
    			 $qry->store_result();
...
$sql = "SELECT * FROM gallery WHERE cat = '4' ";
...
if (mysqli_num_rows($result)> 0) {
 ...
 echo	'<div class="pagination blog-pagination justify-content-center d-flex p-5 mt-10">
  ...
  <ul class="pagination">' ;
  if($page > 1){
  	 echo '<li class="page-item"><a class="page-link" href="chandan-tilak.php?page='.($page - 1).'">Prev</a></li>';
  }
  ...
  echo '<li class=" '.$active.' page-item"><a class="page-link" href="chandan-tilak.php?page='.$i.' ">'.$i.'</a></li>';
  };

   if($total_page >  $page){
 echo '<li class="page-item"><a class="page-link" href="chandan-tilak.php?page='.($page + 1).'">Next</a></li>';
  }
